...
enum CodexResumeBlock: String, Codable {
    ...
    case authenticationRequired, accountRestricted, sessionIndexUnavailable, sessionArchived
    ...
    var message: String {
        switch self {
        case .authenticationRequired: return L10n.string("Codex 登录已失效或无法读取，请在 Codex 重新登录后检查。")
        case .accountRestricted: return L10n.string("账号当前存在用量或消费限制，请在 Codex 中处理后重新检查。")
        case .sessionIndexUnavailable: return L10n.string("无法读取当前版本的会话索引，请更新 AgentMeter 或使用手动恢复。")
        case .sessionArchived: return L10n.string("原会话已归档，不会自动恢复。请先在 Codex 取消归档。")
        ...
        case .accountUnknown: return L10n.string("尚未关联此中断的登录账号。确认它使用当前 Codex 账号后，可加入自动恢复。")
